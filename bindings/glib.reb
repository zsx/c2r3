...
make object! [
	...
	_GSource: GSource: make struct! compose/deep [
		...
		pointer callback_funcs
		pointer source_funcs
		uint32 ref_count
		uint8 [4] padding4
		pointer context
		int32 priority
	...
	_GSourceFuncs: GSourceFuncs: make struct! compose/deep [
		...
		pointer dispatch
		pointer finalize
		pointer closure_callback
		pointer closure_marshal
	]
	...
	_GIOChannel: GIOChannel: make struct! compose/deep [
		...
		pointer write_cd
		pointer line_term
		uint32 line_term_len
		uint8 [4] padding7
		uint64 buf_size
		pointer read_buf
		pointer encoded_read_buf
		pointer write_buf
		int8 [6] partial_write_buf
		uint32 use_buffer
	...
	_GIOFuncs: GIOFuncs: make struct! compose/deep [
		...
		pointer io_seek
		pointer io_close
		pointer io_create_watch
		pointer io_free
		pointer io_set_flags
		pointer io_get_flags
	]
	_GMarkupParser: GMarkupParser: make struct! compose/deep [
		pointer start_element
		pointer end_element
		pointer text
		pointer passthrough
		pointer error
	...
	_GScannerConfig: GScannerConfig: make struct! compose/deep [
		pointer cset_skip_characters
		pointer cset_identifier_first
		pointer cset_identifier_nth
		pointer cpair_comment_single
		uint32 case_sensitive
	...
	_GThreadFunctions: GThreadFunctions: make struct! compose/deep [
		pointer mutex_new
		pointer mutex_lock
		pointer mutex_trylock
		pointer mutex_unlock
		pointer mutex_free
		pointer cond_new
		pointer cond_signal
		pointer cond_broadcast
		pointer cond_wait
		pointer cond_timed_wait
		pointer cond_free
		pointer private_new
		pointer private_get
		pointer private_set
		pointer thread_create
		pointer thread_yield
		pointer thread_join
		pointer thread_exit
		pointer thread_set_priority
		pointer thread_self
		pointer thread_equal
	]
	...
	_GTypeInfo: GTypeInfo: make struct! compose/deep [
		...
		uint8 [6] padding1
		pointer base_init
		pointer base_finalize
		pointer class_init
		pointer class_finalize
		pointer class_data
		uint16 instance_size
		uint16 n_preallocs
		uint8 [4] padding8
		pointer instance_init
		pointer value_table
	]
	...
	_GInterfaceInfo: GInterfaceInfo: make struct! compose/deep [
		pointer interface_init
		pointer interface_finalize
	...
	_GTypeValueTable: GTypeValueTable: make struct! compose/deep [
		...
		pointer value_free
		pointer value_copy
		pointer value_peek_pointer
		pointer collect_format
		pointer collect_value
		pointer lcopy_format
		pointer lcopy_value
	]
	...
	_GParamSpecClass: GParamSpecClass: make struct! compose/deep [
		...
		uint64 value_type
		pointer finalize
		pointer value_set_default
		pointer value_validate
		pointer values_cmp
		pointer [4] dummy
	]
	...
	_GParamSpecValueArray: GParamSpecValueArray: make struct! compose/deep [
		(GParamSpec) parent_instance
		pointer element_spec
		uint32 fixed_n_elements
	]
	...
	_GTypePluginClass: GTypePluginClass: make struct! compose/deep [
		...
		pointer use_plugin
		pointer unuse_plugin
		pointer complete_type_info
		pointer complete_interface_info
	]
	...
	_GActionInterface: GActionInterface: make struct! compose/deep [
		...
		pointer get_name
		pointer get_parameter_type
		pointer get_state_type
		pointer get_state_hint
		pointer get_enabled
		pointer get_state
		pointer change_state
		pointer activate
	]
	_GActionGroupInterface: GActionGroupInterface: make struct! compose/deep [
		(GTypeInterface) g_iface
		pointer has_action
		pointer list_actions
		pointer get_action_enabled
		pointer get_action_parameter_type
		pointer get_action_state_type
		pointer get_action_state_hint
		pointer get_action_state
		pointer change_action_state
		pointer activate_action
		pointer action_added
		pointer action_removed
		pointer action_enabled_changed
		pointer action_state_changed
		pointer query_action
	]
	_GActionMapInterface: GActionMapInterface: make struct! compose/deep [
		(GTypeInterface) g_iface
		pointer lookup_action
		pointer add_action
		pointer remove_action
	]
	...
	_GAppLaunchContextClass: GAppLaunchContextClass: make struct! compose/deep [
		(GObjectClass) parent_class
		pointer get_display
		pointer get_startup_notify_id
		pointer launch_failed
		pointer launched
	...
	_GAppInfoIface: GAppInfoIface: make struct! compose/deep [
		...
		pointer get_executable
		pointer get_icon
		pointer launch
		pointer supports_uris
		pointer supports_files
		pointer launch_uris
		pointer should_show
		pointer set_as_default_for_type
		pointer set_as_default_for_extension
		pointer add_supports_type
		pointer can_remove_supports_type
		pointer remove_supports_type
		pointer can_delete
		pointer do_delete
		pointer get_commandline
		pointer get_display_name
		pointer set_as_last_used_for_type
		pointer get_supported_types
	]
	...
	_GApplicationCommandLineClass: GApplicationCommandLineClass: make struct! compose/deep [
		(GObjectClass) parent_class
		pointer print_literal
		pointer printerr_literal
		pointer get_stdin
		pointer [11] padding
	]
	...
	_GOutputStreamClass: GOutputStreamClass: make struct! compose/deep [
		...
		pointer close_fn
		pointer write_async
		pointer write_finish
		pointer splice_async
		pointer splice_finish
		pointer flush_async
		pointer flush_finish
		pointer close_async
		pointer close_finish
		pointer _g_reserved1
		pointer _g_reserved2
	...
	_GDriveIface: GDriveIface: make struct! compose/deep [
		...
		pointer eject_button
		pointer get_name
		pointer get_icon
		pointer has_volumes
		pointer get_volumes
		pointer is_media_removable
		pointer has_media
		pointer is_media_check_automatic
		pointer can_eject
		pointer can_poll_for_media
		pointer eject
		pointer eject_finish
		pointer poll_for_media
		pointer poll_for_media_finish
		pointer get_identifier
		pointer enumerate_identifiers
		pointer get_start_stop_type
		pointer can_start
		pointer can_start_degraded
		pointer start
		pointer start_finish
		pointer can_stop
		pointer stop
		pointer stop_finish
		pointer stop_button
		pointer eject_with_operation
		pointer eject_with_operation_finish
		pointer get_sort_key
		pointer get_symbolic_icon
	]
	...
	_GFileEnumeratorClass: GFileEnumeratorClass: make struct! compose/deep [
		...
		pointer next_file
		pointer close_fn
		pointer next_files_async
		pointer next_files_finish
		pointer close_async
		pointer close_finish
		pointer _g_reserved1
		pointer _g_reserved2
	...
	_GFileIface: GFileIface: make struct! compose/deep [
		...
		pointer equal
		pointer is_native
		pointer has_uri_scheme
		pointer get_uri_scheme
		pointer get_basename
		pointer get_path
		pointer get_uri
		pointer get_parse_name
		pointer get_parent
		pointer prefix_matches
		pointer get_relative_path
		pointer resolve_relative_path
		pointer get_child_for_display_name
		pointer enumerate_children
		pointer enumerate_children_async
		pointer enumerate_children_finish
		pointer query_info
		pointer query_info_async
		pointer query_info_finish
		pointer query_filesystem_info
		pointer query_filesystem_info_async
		pointer query_filesystem_info_finish
		pointer find_enclosing_mount
		pointer find_enclosing_mount_async
		pointer find_enclosing_mount_finish
		pointer set_display_name
		pointer set_display_name_async
		pointer set_display_name_finish
		pointer query_settable_attributes
		pointer _query_settable_attributes_async
		pointer _query_settable_attributes_finish
		pointer query_writable_namespaces
		pointer _query_writable_namespaces_async
		pointer _query_writable_namespaces_finish
		pointer set_attribute
		pointer set_attributes_from_info
		pointer set_attributes_async
		pointer set_attributes_finish
		pointer read_fn
		pointer read_async
		pointer read_finish
		pointer append_to
		pointer append_to_async
		pointer append_to_finish
		pointer create
		pointer create_async
		pointer create_finish
		pointer replace
		pointer replace_async
		pointer replace_finish
		pointer delete_file
		pointer delete_file_async
		pointer delete_file_finish
		pointer trash
		pointer trash_async
		pointer trash_finish
		pointer make_directory
		pointer make_directory_async
		pointer make_directory_finish
		pointer make_symbolic_link
		pointer _make_symbolic_link_async
		pointer _make_symbolic_link_finish
		pointer copy
		pointer copy_async
		pointer copy_finish
		pointer move
		pointer _move_async
		pointer _move_finish
		pointer mount_mountable
		pointer mount_mountable_finish
		pointer unmount_mountable
		pointer unmount_mountable_finish
		pointer eject_mountable
		pointer eject_mountable_finish
		pointer mount_enclosing_volume
		pointer mount_enclosing_volume_finish
		pointer monitor_dir
		pointer monitor_file
		pointer open_readwrite
		pointer open_readwrite_async
		pointer open_readwrite_finish
		pointer create_readwrite
		pointer create_readwrite_async
		pointer create_readwrite_finish
		pointer replace_readwrite
		pointer replace_readwrite_async
		pointer replace_readwrite_finish
		pointer start_mountable
		pointer start_mountable_finish
		pointer stop_mountable
		pointer stop_mountable_finish
		int32 supports_thread_contexts
		uint8 [4] padding95
		pointer unmount_mountable_with_operation
		pointer unmount_mountable_with_operation_finish
		pointer eject_mountable_with_operation
		pointer eject_mountable_with_operation_finish
		pointer poll_mountable
		pointer poll_mountable_finish
		pointer measure_disk_usage
		pointer measure_disk_usage_async
		pointer measure_disk_usage_finish
	]
	...
	_GIOStreamClass: GIOStreamClass: make struct! compose/deep [
		(GObjectClass) parent_class
		pointer get_input_stream
		pointer get_output_stream
		pointer close_fn
		pointer close_async
		pointer close_finish
		pointer _g_reserved1
	...
	_GMountIface: GMountIface: make struct! compose/deep [
		...
		pointer can_eject
		pointer unmount
		pointer unmount_finish
		pointer eject
		pointer eject_finish
		pointer remount
		pointer remount_finish
		pointer guess_content_type
		pointer guess_content_type_finish
		pointer guess_content_type_sync
		pointer pre_unmount
		pointer unmount_with_operation
		pointer unmount_with_operation_finish
		pointer eject_with_operation
		pointer eject_with_operation_finish
		pointer get_default_location
		pointer get_sort_key
		pointer get_symbolic_icon
	]
	...
	_GVolumeMonitorClass: GVolumeMonitorClass: make struct! compose/deep [
		(GObjectClass) parent_class
		pointer volume_added
		pointer volume_removed
		pointer volume_changed
		pointer mount_added
		pointer mount_removed
		pointer mount_pre_unmount
		pointer mount_changed
		pointer drive_connected
		pointer drive_disconnected
		pointer drive_changed
		pointer is_supported
		pointer get_connected_drives
		pointer get_volumes
		pointer get_mounts
		pointer get_volume_for_uuid
		pointer get_mount_for_uuid
		pointer adopt_orphan_mount
		pointer drive_eject_button
		pointer drive_stop_button
		pointer _g_reserved1
		pointer _g_reserved2
		pointer _g_reserved3
		pointer _g_reserved4
	...
	_GNativeVolumeMonitorClass: GNativeVolumeMonitorClass: make struct! compose/deep [
		...
		pointer get_mount_for_mount_path
	]
	...
	_GNetworkMonitorInterface: GNetworkMonitorInterface: make struct! compose/deep [
		(GTypeInterface) g_iface
		pointer network_changed
		pointer can_reach
		pointer can_reach_async
		pointer can_reach_finish
	]
	...
	_GPermissionClass: GPermissionClass: make struct! compose/deep [
		(GObjectClass) parent_class
		pointer acquire
		pointer acquire_async
		pointer acquire_finish
		pointer release
		pointer release_async
		pointer release_finish
		pointer [16] reserved
	]
	_GPollableInputStreamInterface: GPollableInputStreamInterface: make struct! compose/deep [
		...
		pointer can_poll
		pointer is_readable
		pointer create_source
		pointer read_nonblocking
	]
	_GPollableOutputStreamInterface: GPollableOutputStreamInterface: make struct! compose/deep [
		...
		pointer is_writable
		pointer create_source
		pointer write_nonblocking
	]
	_GProxyInterface: GProxyInterface: make struct! compose/deep [
		(GTypeInterface) g_iface
		pointer connect
		pointer connect_async
		pointer connect_finish
		pointer supports_hostname
	]
	...
	_GProxyResolverInterface: GProxyResolverInterface: make struct! compose/deep [
		...
		pointer is_supported
		pointer lookup
		pointer lookup_async
		pointer lookup_finish
	]
	_GResolverClass: GResolverClass: make struct! compose/deep [
		(GObjectClass) parent_class
		pointer reload
		pointer lookup_by_name
		pointer lookup_by_name_async
		pointer lookup_by_name_finish
		pointer lookup_by_address
		pointer lookup_by_address_async
		pointer lookup_by_address_finish
		pointer lookup_service
		pointer lookup_service_async
		pointer lookup_service_finish
		pointer lookup_records
		pointer lookup_records_async
		pointer lookup_records_finish
		pointer _g_reserved4
		pointer _g_reserved5
		pointer _g_reserved6
	]
	...
	_GSettingsClass: GSettingsClass: make struct! compose/deep [
		(GObjectClass) parent_class
		pointer writable_changed
		pointer changed
		pointer writable_change_event
		pointer change_event
		pointer [20] padding
	]
	...
	_GTlsBackendInterface: GTlsBackendInterface: make struct! compose/deep [
		(GTypeInterface) g_iface
		pointer supports_tls
		pointer get_certificate_type
		pointer get_client_connection_type
		pointer get_server_connection_type
		pointer get_file_database_type
		pointer get_default_database
	]
	...
	_GTlsConnectionClass: GTlsConnectionClass: make struct! compose/deep [
		(GIOStreamClass) parent_class
		pointer accept_certificate
		pointer handshake
		pointer handshake_async
		pointer handshake_finish
		pointer [8] padding
	]
	...
	_GTlsDatabaseClass: GTlsDatabaseClass: make struct! compose/deep [
		(GObjectClass) parent_class
		pointer verify_chain
		pointer verify_chain_async
		pointer verify_chain_finish
		pointer create_certificate_handle
		pointer lookup_certificate_for_handle
		pointer lookup_certificate_for_handle_async
		pointer lookup_certificate_for_handle_finish
		pointer lookup_certificate_issuer
		pointer lookup_certificate_issuer_async
		pointer lookup_certificate_issuer_finish
		pointer lookup_certificates_issued_by
		pointer lookup_certificates_issued_by_async
		pointer lookup_certificates_issued_by_finish
		pointer [16] padding
	]
	...
	_GTlsInteractionClass: GTlsInteractionClass: make struct! compose/deep [
		(GObjectClass) parent_class
		pointer ask_password
		pointer ask_password_async
		pointer ask_password_finish
		pointer request_certificate
		pointer request_certificate_async
		pointer request_certificate_finish
		pointer [21] padding
	]
	...
	_GTlsPasswordClass: GTlsPasswordClass: make struct! compose/deep [
		...
		pointer get_value
		pointer set_value
		pointer get_default_warning
		pointer [4] padding
	]
	_GVfsClass: GVfsClass: make struct! compose/deep [
		(GObjectClass) parent_class
		pointer is_active
		pointer get_file_for_path
		pointer get_file_for_uri
		pointer get_supported_uri_schemes
		pointer parse_name
		pointer local_file_add_info
		pointer add_writable_namespaces
		pointer local_file_set_attributes
		pointer local_file_removed
		pointer local_file_moved
		pointer deserialize_icon
		pointer _g_reserved1
		pointer _g_reserved2
		pointer _g_reserved3
		pointer _g_reserved4
	...
	_GVolumeIface: GVolumeIface: make struct! compose/deep [
		...
		pointer can_eject
		pointer mount_fn
		pointer mount_finish
		pointer eject
		pointer eject_finish
		pointer get_identifier
		pointer enumerate_identifiers
		pointer should_automount
		pointer get_activation_root
		pointer eject_with_operation
		pointer eject_with_operation_finish
		pointer get_sort_key
		pointer get_symbolic_icon
	...
	_GDBusInterfaceSkeletonClass: GDBusInterfaceSkeletonClass: make struct! compose/deep [
		...
		pointer get_info
		pointer get_vtable
		pointer get_properties
		pointer flush
		pointer [8] vfunc_padding
		pointer g_authorize_method
		pointer [8] signal_padding
	]
	_GDBusObjectIface: GDBusObjectIface: make struct! compose/deep [
		(GTypeInterface) parent_iface
		pointer get_object_path
		pointer get_interfaces
		pointer get_interface
		pointer interface_added
		pointer interface_removed
	]
	_GDBusObjectSkeletonClass: GDBusObjectSkeletonClass: make struct! compose/deep [
		(GObjectClass) parent_class
		pointer authorize_method
		pointer [8] padding
	]
	...
	_GDBusObjectManagerIface: GDBusObjectManagerIface: make struct! compose/deep [
		...
		pointer get_object
		pointer get_interface
		pointer object_added
		pointer object_removed
		pointer interface_added
		pointer interface_removed
	]
	_GDBusObjectManagerClientClass: GDBusObjectManagerClientClass: make struct! compose/deep [
		(GObjectClass) parent_class
		pointer interface_proxy_signal
		pointer interface_proxy_properties_changed
		pointer [8] padding
	]
	...
	_GRemoteActionGroupInterface: GRemoteActionGroupInterface: make struct! compose/deep [
		(GTypeInterface) g_iface
		pointer activate_action_full
		pointer change_action_state_full
	]
	_GMenuModelClass: GMenuModelClass: make struct! compose/deep [
		(GObjectClass) parent_class
		pointer is_mutable
		pointer get_n_items
		pointer get_item_attributes
		pointer iterate_item_attributes
		pointer get_item_attribute_value
		pointer get_item_links
		pointer iterate_item_links
		pointer get_item_link
	]
