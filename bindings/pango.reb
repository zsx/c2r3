...
make object! [
	...
	_PangoRendererClass: PangoRendererClass: make struct! compose/deep [
		...
		pointer draw_glyphs
		pointer draw_rectangle
		pointer draw_error_underline
		pointer draw_shape
		pointer draw_trapezoid
		pointer draw_glyph
		pointer part_changed
		pointer begin
		pointer end
		pointer prepare_run
		pointer draw_glyph_item
		pointer _pango_reserved2
		pointer _pango_reserved3
		pointer _pango_reserved4
	]
