...
;recycle/torture
; produced by
; nm -D --defined-only /usr/lib/libglib-2.0.so|grep g_|awk '{print $3}'
glib-funcs: [
	"g_access"
	"g_allocator_free"
	"g_allocator_new"
	...
	"g_assertion_message"
	;"g_assertion_message_cmpnum" ;unsupported long double
...
function-filter: func [
	...
	if f/availability != clang/enum clang/CXAvailabilityKind 'CXAvailability_Available [return false]
	case [
		found? find glib-funcs f/name [
			f/lib: "glib"
			true
		]
		found? find gobject-funcs f/name [
			f/lib: "gobject"
			true
		]
		found? find gmodule-funcs f/name [
			f/lib: "gmodule"
			true
		]
		found? find gio-funcs f/name [
			f/lib: "gio"
			true
		]
		'else [
...
function-ns: func [
	...
	either found? find/match f/name "g_" [
		"g_"
	][
		""
	]
...
struct-filter: func [
	...
	if #"G" = first s/name [return true]
	foreach a s/aliases [
		if #"G" = first a [return true]
	]
	false
]
...
OUTPUT: %glib-binding.reb

do %../lib/c2r3.reb

compile-glib-mod: function [
	header [any-string! block!]
][
	;compile glib
	argv-data: compose [
	...
	foreach h header [
		append argv-data r2utf8-string h
	]
...
compile-glib-mod "/usr/include/glib-2.0/glib.h"
compile-glib-mod "/usr/include/glib-2.0/glib-object.h"
compile-glib-mod "/usr/include/glib-2.0/gmodule.h"
compile-glib-mod "/usr/include/glib-2.0/gio/gio.h"
